...
class Program
{
    static void Main(string[] args)
    {
        ...
        Product order1Product1 = new Product("Basketball", 158794, 2, 19.99m);
        Product order1Product2 = new Product("Basketball Shorts", 548792, 5, 12.00m);
        Product order1Product3 = new Product("Basketball Shoes", 487596, 1, 75.00m);
        ...
        Product order2Product1 = new Product("Fishing Pole", 645712, 1, 48.25m);
        Product order2Product2 = new Product("Tacklebox with lures", 115422, 1, 35.98m);
